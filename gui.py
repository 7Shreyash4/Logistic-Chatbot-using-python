...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About Lucy", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Lucy v1.0",'Lucy is a chatbot for answering Customer queries .\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer questions regarding orders of customer and tracking of their order and many more. ')

    def about(self):
        tkinter.messagebox.showinfo("Lucy's Developers","-Shreyash Gupta\n-Yaswanth\n-Naidu\n-Nikhil")
